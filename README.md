...
- **Status:** **Phase 1** — project skeleton, the **PC**, and the **Mini Workbench**.
  Market / shipping / Minis are stubs where they connect.
...
src/main/java/com/dierks/homecraft/
  ...
  integration/                 Towny + WorldGuard protection (reflection)
  item/                        tagged custom items
  storage/                     SQLite datastore + DAO
